...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_sign.setGeometry(QtCore.QRect(270, 440, 93, 28))
        self.btn_sign.setObjectName("btn_sign")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(250, 310, 391, 87))
        self.txt_sign.setObjectName("txt_sign")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(90, 340, 91, 21))
        font = QtGui.QFont()
        ...
        self.txt_info.setGeometry(QtCore.QRect(250, 150, 391, 87))
        self.txt_info.setObjectName("txt_info")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(290, 60, 231, 51))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(90, 180, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.btn_verify.setGeometry(QtCore.QRect(450, 440, 93, 28))
        self.btn_verify.setObjectName("btn_verify")
        self.btn_gen_keys = QtWidgets.QPushButton(self.centralwidget)
        self.btn_gen_keys.setGeometry(QtCore.QRect(570, 70, 93, 28))
